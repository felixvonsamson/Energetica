...
class BaseProjectConfig(BaseModel):
    ...
    base_price: int = Field(description="Base price of the power facility")
    base_construction_time: float = Field(description="Base construction time in seconds")
    base_construction_pollution: float = Field(description="Base construction pollution in kg CO2", default=0)
