...
const_config = {
    "assets": {
        ...
        "windmill": {
            ...
            "base_construction_time": timedelta(days=1, hours=2).total_seconds(),
        ...
        "watermill": {
            ...
            "base_construction_time": timedelta(hours=22).total_seconds(),
        ...
        "coal_burner": {
            ...
            "base_construction_time": timedelta(days=6, hours=0).total_seconds(),
        ...
        "gas_burner": {
            ...
            "base_construction_time": timedelta(days=1, hours=20).total_seconds(),
            "construction_power_factor": 0.56,
        ...
        "small_water_dam": {
            ...
            "base_construction_time": timedelta(days=7, hours=6).total_seconds(),
        ...
        "onshore_wind_turbine": {
            ...
            "base_price": 270_000,
            "base_power_generation": 11_000_000,
            "base_construction_time": timedelta(days=2, hours=18).total_seconds(),
        ...
        "combined_cycle": {
            ...
            "base_construction_time": timedelta(days=4, hours=0).total_seconds(),
            "construction_power_factor": 0.56,
        ...
        "nuclear_reactor": {
            ...
            "base_construction_time": timedelta(days=12).total_seconds(),
        ...
        "large_water_dam": {
            ...
            "base_construction_time": timedelta(days=9).total_seconds(),
        ...
        "PV_solar": {
            ...
            "base_construction_time": timedelta(days=1).total_seconds(),
        ...
        "nuclear_reactor_gen4": {
            ...
            "base_construction_time": timedelta(days=15).total_seconds(),
        ...
        "small_pumped_hydro": {
            ...
            "base_construction_time": timedelta(hours=20).total_seconds(),  # [in-game seconds]
        ...
        "molten_salt": {
            ...
            "base_construction_time": timedelta(days=3).total_seconds(),
        ...
        "hydrogen_storage": {
            ...
            "base_construction_time": timedelta(days=1, hours=12).total_seconds(),
        ...
        "solid_state_batteries": {
            ...
            "base_construction_time": timedelta(days=2).total_seconds(),
        ...
        "industry": {
            ...
            "base_income_per_day": 12_000,  # [¤/in-game day]
        ...
        "coal_mine": {
            ...
            "base_price": 28_500,  # [¤]
            "base_construction_time": timedelta(days=1, hours=6).total_seconds(),  # [in-game seconds]
