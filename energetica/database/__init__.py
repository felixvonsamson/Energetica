...
if TYPE_CHECKING:
    ...
    from energetica.enums import ExtractionFacilityType, PowerFacilityType, ProjectType, StorageFacilityType, WorkerType
...
class DBModel:
    ...
    def delete(self: T) -> None:
        """Delete the object from the engine database."""
