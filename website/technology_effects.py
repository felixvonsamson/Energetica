...
def construction_time_multiplier(player, facility):
    ...
    if facility in engine.engine.storage_facilities + engine.controllable_facilities + engine.renewables + engine.extraction_facilities + engine.functional_facilities :
