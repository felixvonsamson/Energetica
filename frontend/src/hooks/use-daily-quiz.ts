/**
 * Hooks for daily quiz functionality. The quiz question changes daily and
 * players can answer once per day for XP rewards.
 */
...
/**
 * Hook to fetch today's daily quiz question. Returns the question, answers, and
 * whether the player has already answered today.
 */
...
/**
 * Hook to submit an answer to today's daily quiz. Returns the updated quiz
 * state with the correct answer revealed.
 */
