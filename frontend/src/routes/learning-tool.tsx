    ...
    const game_elements = [
        {
            ...
            description:
                "Make <b>strategic energy investments</b> by analysing the Levelised Cost of Electricity (LCOE)." +
                ...
                <section>
                    <div className="max-w-6xl mx-auto grid gap-8 2xl:grid-cols-2">
                        {game_elements.map((f) => (
                            <div
                                key={f.title}
                                className="flex flex-col gap-4 p-6 text-center bg-bone rounded-4xl shadow-md"
                            >
