        ...
        <nav className="navbar medium">
            <div className="tan_green flex-row main_dropdown">
                ...
                <b onClick={() => setExpanded(!expanded)}>
                    <span className="navbar-toggler-icon margin">
                        <i className="fa fa-bars" id="dropdown-navbar"></i>
                    </span>
                </b>
            </div>
            <div
...
function NavBarSection({
    ...
    return (
        <li className="dropdown">
            <a
                className="navbar_item flex-row"
                onClick={() => setExpanded(!expanded)}
            >
                <img
                    src="/static/images/icons/dropdown.png"
...
function NavBarItem({ name, icon }: { name: string; icon: string }) {
    return (
        <a className="navbar_item flex-row" key={name}>
            <img
