...
/**
 * Convert numeric resolution to string resolution.
 * Useful for API calls or query keys that expect string values.
 */
...
/**
 * Convert string resolution to numeric resolution.
 * Useful for parsing URL params or API responses.
 */
