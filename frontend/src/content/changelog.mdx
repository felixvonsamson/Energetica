...
## Version 0.11.3 - April 27, 2026

**New UI**: The user interface has been redesigned to be more modern and user-friendly. The layout has been improved for better navigation.

**Documented API endpoints**: The API endpoints are now documented and can be accessed through [game-domain-adress]/docs. This will allow developers to create their own tools that can interact with the game.

**A lot more**: So many things happened between December 2024 and now, don't ask me to list all the changes here ^_^.