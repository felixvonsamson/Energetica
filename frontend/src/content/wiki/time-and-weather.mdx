...
The solar irradiance is used to calculate the electricity production of [solar power facilities](./power-facilities.mdx#solar-power-generation).
...
The wind speed is used to calculate the electricity production of [wind power facilities](./power-facilities.mdx#wind-power-generation).
...
The river discharge is used to calculate the electricity production of [hydropower facilities](./power-facilities.mdx#hydro-power-generation).

The river discharge is given in cubic meters per second (m³/s) and varies seasonally (see [figure](./power-facilities.mdx#seasonal-variation-rivers-graph)).
