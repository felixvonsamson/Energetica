...
<div className="flex justify-center my-8">
    <img
        src="/static/images/wiki/cloud_coverage.webp"
...
The river discharge is used to calculate the electricity production of [hydropower facilities](./power-facilities.mdx#hydro-family).

The river discharge is given in cubic meters per second (m³/s) and varies seasonally (see [figure](./power-facilities.mdx#hydropower-generation)).
