...
If a player's money balance falls below the equivalent of one day's industry income in the negative, they are automatically expelled from their network. This prevents a bankrupt player from disrupting market stability by erratically entering and leaving market participation.

After expulsion, a player must recover a positive balance before they can join or create a network again.
