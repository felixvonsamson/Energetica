...
Players can only join or create a network if they have a positive balance before.

If a player's money balance falls below zero, they are automatically removed from their network.
